  ...
  return (
    <div className="inline-block px-3">
      <div className="relative max-w-xs overflow-hidden rounded-lg transition-shadow duration-300 ease-in-out">
        <div className="flex text-lg sm:text-xs h-[15rem] w-[19rem] bg-[#C9FFFF] flex-col items-center justify-center p-2 md:p-6 rounded-[30px] shadow-md max-w-xs mx-auto">
