...
const images = [
    {
        original: "./cottage2/cottage2-1.png",
        thumbnail: "./cottage2/cottage2-1.png",
    },
    {
        original: "./cottage2/cottage2-2.png",
        thumbnail: "./cottage2/cottage2-2.png",
    },
    {
        original: "./cottage2/cottage2-2.png",
        thumbnail: "./cottage2/cottage2-2.png",
        ...
        <div>
          ...
          <div className="py-32 px-8 md:px-16 ">
            ...
            <div className="para-family mt-[56px]">
              ...
              <p className="text-[16px] md:text-[20px] font-extralight my-[45px]">
