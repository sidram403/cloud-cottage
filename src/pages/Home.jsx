  ...
  return (
    <div>
      ...
      <div className="py-8 lg:py-20 ">
        <h1 className="header-family text-black text-[35px] md:text-[40px] py-10 uppercase text-center">
          Featured Cottages
        </h1>
      ...
      <div className="relative h-[500px] bg-cover bg-center " style={{ backgroundImage: `url('./bg-welcome.png')` }}>
        <div className="absolute inset-y-0 right-0 flex items-center justify-center bg-welcome-color bg-opacity-50 w-full md:w-1/2">
          <div className="text-center text-white py-12 px-8 md:px-12 lg:px-20 w-[100%]">
            ...
            <p className="font-normal mb-4 text-center para-family text-[14px] md:text[18px]">
      ...
      <div className="py-20 px-4 sm:px-6 md:px-8 lg:px-10 bg-white">
        <h2 className="text-3xl sm:text-4xl lg:text-[32px] font-normal text-center uppercase header-family">
